...
import iconGabrielG from "../../img/Devs/iconGabrielG.jpeg"
            ...
            <div className='faq'>
                ...
                <div className='devs'>
                    <SwiperSlide className='dev-ind'>
                        <img src={iconGabrielG} alt="Imagem de perfil - Cauã"/>
                        <p className='cor-0 fonte-gerais'>Gabriel Gomes Ferreira</p>
                        <p className='fonte-gerais'><strong>Tech Lead</strong></p>
                        <p className='cor-0 fonte-gerais'>Além de exercer o cargo de Tech Lead geral, Gabriel também faz parte da equipe de  <span className='cor-3'>desenvolvedores front-end</span>. Possui 19 anos e grande afinidade com front-end.</p>
                        <span>
                            <a href="https://github.com/cheergabs" target="_blank">
                            <img src={github} alt='Icon do GitHub' width="28px"/>
                            </a>
                            <a href="https://www.linkedin.com/in/gabriel-gomes-ferreira?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank">
